...
thief-backpack-window-description =
    Ниже приведены панели с определённым содержимым.
    Чтобы выбрать набор, кликните по кнопке "Выбрано"
    Грамотно оценивайте свои цели и возможности, взять сверх лимита не выйдет!
